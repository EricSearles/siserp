    ...
    if (isset($_POST['btnCadastrar']) && $_POST['btnCadastrar'] == 'Gerar Orçamento') {
        ...
        if (empty($ultimoId)) {
            ...
            if (in_array('0', $dados['produto'])) {
                ...
                //conta o tamanho da array para inserir na tabela itenOrcamento (Serviços)
                $tamanhoProduto = count($valorProduto);
        ...
        <body>
            ...
            <main role="main" class="container">
                ...
                <div class="my-3 p-3 bg-white rounded shadow-sm">
                  ...
                  <!--  <br/><h6 class="border-bottom border-gray pb-2 mb-0"><a href="?pg=0&acao=novo">Novo Orçamento</a></h6> -->
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            ...
                            <label>Serviço: </label><select name="servico[' . $item->idItem . ']" class="form-control">
...
//conta a quantidade total de registros na tabela
                            ...
                            foreach ($objOrcamento->querySelecionaAntigo($inicial, $numreg) as $res) {
