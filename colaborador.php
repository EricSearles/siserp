           ...
           //PARA INSERIR OS DOCUMENTOS CNPF, INSC ESTADUAL, INSC MUNICIPAL NA TABELA DOCUMENTOS
            ...
            $insertEnd = $objColaborador->queryInsertEnd($end);
                  ...
                  $ctt = array(
                        ...
                        $_SESSION['msg'] = "Solicitante Cadastrado com sucesso.";

                        }else{
                             
                          $_SESSION['msg'] = "Não foi possível cadastrar o solicitante, tente novamente ou entre em contato com o desenvolvedor.";
                        }                     
        }    
    }
}
...
if(isset($_POST['btnCadastrar']) && $_POST['btnCadastrar']=='Alterar'){  
    ...
    if($_GET['tipoColaborador'] == '1'){          
        $cpf   = $dados['Cpf'];
        $cpf = preg_replace("/[^0-9]/", "", $cpf);
        if($objColaborador->queryUpdateColaboradorPF($user, $nome) == 'ok'){ 
             //echo "o nome foi alterado com sucesso";  
             //echo $cpf;
            if($objColaborador->queryUpdateDocPF($user,$cpf)){
                //echo "o cpf foi alterado com sucesso"; 
                
                if($objColaborador->queryUpdateEnd($user, $dados) == 'ok'){
                
                //echo "Documento Alterado";
                
                if($objColaborador->queryUpdateCTT($user, $dados) == 'ok'){
            ...
            if($objColaborador->queryUpdateColaboradorPJ($user, $dados) == 'ok'){   
                
                if($objColaborador->queryUpdateDocPJ($user, $dados) == 'ok'){
    ...
    if(isset($_GET['acao']) AND $_GET['acao'] == 'excluir'){    
        $user = $objFuncao->base64($_GET['user'], 2);
            if($objColaborador->queryDeleteColaborador($user) == 'ok'){
                
                if($objColaborador->queryDeleteEndereco($user) == 'ok'){
                            
                    if($objColaborador->queryDeleteContato($user) == 'ok'){
                        
                        if($objColaborador->queryDeleteDocumentoPF($user) == 'ok'){
                        ...
                        if($objColaborador->queryDeleteDocumentoPJ($user) == 'ok'){
...
<head>
	...
	<title>Colaborador - MVArquitetura</title>
    ...
    ?>
         ...
         <div class="my-3 p-3 bg-white rounded shadow-sm">
             <table cellspacing="4" cellpadding="6">
                <tr>
                    <th>Buscar Colaborador:</th>
                        </tr>
                        <form name="busca" method="GET" action="exibeColaborador.php"  class="form-inline my-2 my-lg-0">
                            <tr>  
                                <td>
                                        <input type="text" name="colaborador" id="search-colaborador" placeholder="Nome Solicitante" size="20" class="form-control"/>
                                        <input type="hidden" name="idColaborador" id="search-idcolaborador" />
                                        <input type="hidden" name="tipoColaborador" id="search-tipocolaborador" />
             ...
             <h6 class="border-bottom border-gray pb-2 mb-0"><a href="?pg=0&acao=novo">Novo Solicitante</a></h6>
<!--****************************Corte**********************************  -->
<div class="container">
 ...
 <?php
 //Exibe o form para cadastrar novo colaboradr
        ...
        <div class="media text-muted pt-3">  
            ...
            <div class="col-md-auto">
                ...
                <form method="POST" action="" autocomplete="off" class="form-signin">
                    ...
                    <H5> Cadastrar Novo Colaborador</h5>
                ...
                <h5>Alterar/Incluir Dados do Cliente</h5>
                    ...
                    ';
                        ...
                        if($tipo == 1){
                            ...
                            $up = $objColaborador->querySelecionaColaboradorPF($userID, $tipo);
                                ...
                                foreach ($up as $resPF) {}
                                    ...
                                    echo'   
                                        ...
                                        <label for="nome">Nome:</label><br/>
                                        <input name="nome" type="text" value="'.$resPF->nomeColaborador.'" class="form-control" /><br/>
                            ...
                            $up = $objColaborador->querySelecionaColaboradorPJ($userID, $tipo);
...
<!--****************************Corte**********************************  -->
        ...
        <div class="my-3 p-3 bg-white rounded shadow-sm">
        <h6 class="border-bottom border-gray pb-2 mb-0">Solicitantes Cadastrados</h6>
        <div class="media text-muted pt-3">
            <table class="table">
                <thead>
                <tr>
...
$quantreg = $objColaborador->querySelectTotal();
 $i = $quantreg;
           foreach($objColaborador->querySelectPag($inicial, $numreg) as $res){
          ...
          echo ' <tr>
            ...
            if(empty($res->email)){
                ...
                echo '<td><a href="?pg='.$pg.'&acao=alterar&user='.$objFuncao->base64($res->idColaborador, 1).'&tipoColaborador='.$res->tipoColaborador.'" title="Cadastrar e-mail">Cadastrar e-mail</td>';
            ...
            if($res->dddTel == ('0')){
                ...
                echo '<td><a href="?pg='.$pg.'&acao=alterar&user='.$objFuncao->base64($res->idColaborador, 1).'&tipoColaborador='.$res->tipoColaborador.'" title="Cadastrar Telefone.">Cadastrar Telelefone</td>';
            ...
            if($res->dddCel == ('0')){
                ...
                echo '<td><a href="?pg='.$pg.'&acao=alterar&user='.$objFuncao->base64($res->idColaborador, 1).'&tipoColaborador='.$res->tipoColaborador.'" title="Cadastrar Celular.">Cadastrar Celular</td>';
           ...
           echo'         
                     <td><a href="exibeColaborador.php?pg='.$pg.'&acao=ver&user='.$objFuncao->base64($res->idColaborador, 1).'&tipoColaborador='.$res->tipoColaborador.'" title="Visualizar esse dado"><img src="images/ico-visualizar.png"  height="16" alt="Visualizar"></td>
                    <td><a href="?pg='.$pg.'&acao=alterar&user='.$objFuncao->base64($res->idColaborador, 1).'&tipoColaborador='.$res->tipoColaborador.'" title="Alterar esse dado"><img src="images/ico-editar.png" width="16" height="16" alt="Editar"></td>
                    <td><a href="?pg='.$pg.'&acao=excluir&user='.$objFuncao->base64($res->idColaborador, 1).'" onclick="return confirm(\'Tem certeza que deseja excluir esse registro?\');" title="Excluir esse dado"><img src="images/ico-excluir.png" width="16" height="16" alt="Excluir"></td>
                </tr>';
