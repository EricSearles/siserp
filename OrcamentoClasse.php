...
class Orcamento {
    ...
    public function querySeleciona($inicial, $numreg){
        try{          
            $SQL = "SELECT 
                    ...
                    WHERE orcamento.status > 0 ORDER BY orcamento.idOrcamento DESC LIMIT :inicial, :numreg";
...
//            WHERE responsavelcliente.idCliente = :id AND contato.identificador = '4'
//            ";
    ...
    public function queryInsertOrcamento($dados, $total){
        try{
            ...
            $sqlInserir = $this->conecta->conectar()->prepare("INSERT INTO `orcamento` (`numero`, `data`, `responsavel`, `colaborador`, `cliente`, `total`, `validade`, `obsOrcamento`, `status`) VALUES (:num, :data, :responsavel, :solicitante, :cliente, :total, :validade, :obs, :status)");
